...
/-- Case `verum` of `predCut_aux` (generated by case_skeleton.py; statement only, dispatch=induction). -/
theorem predCut_aux_case_verum
    {n : ℕ}
  ...
  intro hH hP hrH hαΩ
  exact .verum (hP ∅ r α hr hαΩ hrH p1) p2 p3
